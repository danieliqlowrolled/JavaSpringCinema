...
public class CinemaEventController {
    ...
    */    
    private void createDemoData(){
        ...
        m5 = new Movie("+1");
        m5.setDesc("1. hinzugefügter Film");
        ...
        m6 = new Movie("+2");
        m6.setDesc("2. hinzugefügter Film");
        ...
        ce9 = new CinemaEvent(8, m5, ch1, "31.03.2023, 15:00 Uhr");
        ce10 = new CinemaEvent(9, m6, ch2, "31.03.2023, 15:00 uhr");

    }

    public CinemaEvent[] getAllCE(){
        CinemaEvent[] allCinemaEvents = new CinemaEvent[11];
        ...
        allCinemaEvents[8] = getCe8();
        allCinemaEvents[9] = getCe9();
        allCinemaEvents[10] = getCe10();
